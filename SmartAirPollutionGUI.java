...
public class SmartAirPollutionGUI implements ActionListener {
	...
	private JPanel SubscribeToPollutantAlertsJPanel() {
	...
	private JPanel UnsubscribeFromAlertsJPanel() {
	...
	private JPanel HistoricalDataServiceJPanel() {
	...
	public static void main(String[] args) {
		...
		SmartAirPollutionGUI gui = new SmartAirPollutionGUI();
	...
	private void build() {
		...
		panel.add(SubscribeToPollutantAlertsJPanel());
		panel.add(UnsubscribeFromAlertsJPanel());
		panel.add(HistoricalDataServiceJPanel());
	...
	public <SubscribeToPollutantAlerts> void actionPerformed(ActionEvent e) {
		...
		if (label.equals("getLatestAirQualityData AirQualityService")) {
			...
			else historicalDataRequest = false;
			{
				...
				//retreving reply from service
				GetHistoricalDataResponse response = blockingStub.GetHistoricalDataRequest(request);
